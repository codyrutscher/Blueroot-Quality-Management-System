...
export default function ProductDetail({
  ...
  const fetchAvailableDocuments = async () => {
    try {
      ...
      const data = await response.json();
      const unassignedDocs = data.documents.filter(
        (doc: any) => !doc.productId
      );
      ...
      <div className="max-w-full">
            ...
            <div className="lg:col-span-2 bg-white border border-gray-200 rounded-lg p-6">
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <dd className="text-sm font-medium text-gray-900">
                    {product.therapeuticPlatform || "N/A"}
                  </dd>
                </div>
                <div>
                  <dt className="text-sm text-gray-500">Nutrient Type</dt>
                  <dd className="text-sm font-medium text-gray-900">
                    {product.nutrientType || "N/A"}
                  </dd>
                </div>
                <div>
                      ...
                      <div className="pt-3 border-t border-gray-100">
                        {(doc.status === "EDIT_MODE" ||
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {(!doc.status || doc.status === "EDIT_MODE") &&
              ...
              {labelsLoading ? (
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          onClick={() => {
                            ...
                            link.href = `/api/labels/download?path=${encodeURIComponent(
                              label.filePath
                            )}`;
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">
                    No labels have been uploaded for this product yet.
                  </p>
                </div>
              )}
            </div>
        ...
        {activeTab === "quality" && (
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-600">
              Quality management features will be available here.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete "{documentToDelete.title}" from
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, healthCategory: e.target.value })
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-black"
            />
          </div>
          ...
          <div className="md:col-span-2">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, containsIron: e.target.checked })
                }
                className="mr-2"
              />
